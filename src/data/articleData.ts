...
export const SUSTAINABILITY_ARTICLE: ArticleData = {
  "id": "instituicoes-financeiras-sustentabilidade",
  "title": "Sustentabilidade bancária e percepção dos clientes",
  "subtitle": "Uma releitura da minha monografia de Ciências Contábeis",
  "author": "Priscilla Santos Cahino",
  "undergraduate": "Ciências Contábeis",
  "originalYear": 2013,
  "revisitYear": 2026,
  "tags": [
    "Finanças",
  ...
  "sections": [
    ...
    {
      "id": "secao-4",
      "title": "A relação com meu momento profissional",
      "paragraphs": [
        "Minha experiência nos segmentos bancário e imobiliário envolve atendimento, relacionamento com clientes, crédito e acompanhamento de processos. Ao retomar a monografia, percebo que o interesse em entender o que as pessoas conhecem, esperam e precisam também esteve presente na minha formação em Contabilidade.",
        "Hoje, como estudante de Análise e Desenvolvimento de Sistemas, encontro nessa experiência acadêmica uma referência para os conhecimentos que venho desenvolvendo em dados e experiência do cliente. Formular uma pergunta, organizar respostas e reconhecer os limites de uma informação são aprendizados que podem contribuir para essa nova etapa.",
        "Essa conexão não significa que eu já atuasse profissionalmente em tecnologia ou dominasse ferramentas atuais de análise. Ela mostra como minha formação e minha vivência com clientes podem contribuir para o aprendizado que estou construindo agora."
      ]
    },
    {
      "id": "secao-5",
      "title": "Limites desta releitura",
      "paragraphs": [
        "As planilhas originais de tabulação não estão mais disponíveis. Como a revisão identificou divergências entre números do texto e dos gráficos, esta versão não apresenta percentuais nem quantidade de participantes. O foco está no processo de pesquisa e nos temas discutidos, sem validar os cálculos originais ou generalizar os resultados."
      ]
    }
  ],
  "conclusion": {
    "title": "Uma possibilidade de continuidade",
    "paragraphs": [
      "O tema pode servir de ponto de partida para um novo exercício acadêmico, com perguntas revisadas, documentação da coleta e uma base que permita conferir os resultados. Isso possibilitaria praticar ferramentas de análise e visualização sem reconstruir como reais respostas que já não estão disponíveis.",
      "O valor que encontro nesse trabalho está na experiência de investigar uma questão de negócio a partir da percepção das pessoas. É um aprendizado que se soma à minha trajetória e ao interesse em desenvolver soluções mais claras e úteis para quem as utiliza."
    ],
    "closingQuote": "Investigar uma questão de negócio também exige ouvir as pessoas e reconhecer os limites das informações disponíveis."
  },
  "originalResearch": {
    ...
    "keyFindings": [
      ...
      "Articulação entre pesquisa documental, respostas dos clientes e perspectiva da gestão.",
      "Aprendizado sobre organização de informações e limites da interpretação dos dados."
    ]
  }
};
