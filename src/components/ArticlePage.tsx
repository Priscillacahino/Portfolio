          ...
          <div className="p-6 bg-[#161616] border border-[#2e2e2e] flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="space-y-2 text-center sm:text-left">
              ...
              <p className="text-xs text-[#aaa] font-light leading-relaxed">
                Graduada em Ciências Contábeis pelo UNIESP (2013), estudante de Análise e Desenvolvimento de Sistemas e com pós-graduação em Engenharia de Dados. Mais de 18 anos de experiência consolidada em operações financeiras e relacionamento com clientes.
              </p>
